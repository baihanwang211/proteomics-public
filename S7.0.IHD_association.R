...
sum(overlap_1_to_1_ihd$olink_p_bonferroni<0.05)
sum(overlap_1_to_1_ihd$soma_normal_p_bonferroni<0.05)
sum(overlap_1_to_1_ihd$soma_non_normal_p_bonferroni<0.05)
...
overlap_1_to_1_ihd$olink_sig_bonferroni <- F
overlap_1_to_1_ihd$olink_sig_bonferroni[overlap_1_to_1_ihd$olink_p_bonferroni<0.05 & sign(overlap_1_to_1_ihd$olink_coef)>0] <- "Positive"
overlap_1_to_1_ihd$olink_sig_bonferroni[overlap_1_to_1_ihd$olink_p_bonferroni<0.05 & sign(overlap_1_to_1_ihd$olink_coef)<0] <- "Inverse"
overlap_1_to_1_ihd$olink_sig_bonferroni[overlap_1_to_1_ihd$olink_p_bonferroni>=0.05] <- "n.s."
overlap_1_to_1_ihd$olink_sig_bonferroni <- factor(overlap_1_to_1_ihd$olink_sig_bonferroni,levels=c("Positive","Inverse","n.s."))
table(overlap_1_to_1_ihd$olink_sig_bonferroni)
n_sig <- sum(overlap_1_to_1_ihd$olink_sig_bonferroni!="n.s.")

olink_threshold <- max(overlap_1_to_1_ihd$olink_p[overlap_1_to_1_ihd$olink_p_bonferroni<0.05])

volcano_olink <- ggplot(overlap_1_to_1_ihd, aes(x=olink_coef, y=-log(olink_p,10))) +
  geom_point(aes(color = olink_sig_bonferroni), size = 0.5) +
...
overlap_1_to_1_ihd$soma_normal_sig_bonferroni <- F
overlap_1_to_1_ihd$soma_normal_sig_bonferroni[overlap_1_to_1_ihd$soma_normal_p_bonferroni<0.05 & sign(overlap_1_to_1_ihd$soma_normal_coef)>0] <- "Positive"
overlap_1_to_1_ihd$soma_normal_sig_bonferroni[overlap_1_to_1_ihd$soma_normal_p_bonferroni<0.05 & sign(overlap_1_to_1_ihd$soma_normal_coef)<0] <- "Inverse"
overlap_1_to_1_ihd$soma_normal_sig_bonferroni[overlap_1_to_1_ihd$soma_normal_p_bonferroni>=0.05] <- "n.s."
overlap_1_to_1_ihd$soma_normal_sig_bonferroni <- factor(overlap_1_to_1_ihd$soma_normal_sig_bonferroni,levels=c("Positive","Inverse","n.s."))
table(overlap_1_to_1_ihd$soma_normal_sig_bonferroni)
n_sig <- sum(overlap_1_to_1_ihd$soma_normal_sig_bonferroni!="n.s.")

soma_normal_threshold <- max(overlap_1_to_1_ihd$soma_normal_p[overlap_1_to_1_ihd$soma_normal_p_bonferroni<0.05])

volcano_soma_normal <- ggplot(overlap_1_to_1_ihd, aes(x=soma_normal_coef, y=-log(soma_normal_p,10))) +
  geom_point(aes(color = soma_normal_sig_bonferroni), size = 0.5) +
...
overlap_1_to_1_ihd$soma_non_normal_sig_bonferroni <- F
overlap_1_to_1_ihd$soma_non_normal_sig_bonferroni[overlap_1_to_1_ihd$soma_non_normal_p_bonferroni<0.05 & sign(overlap_1_to_1_ihd$soma_non_normal_coef)>0] <- "Positive"
overlap_1_to_1_ihd$soma_non_normal_sig_bonferroni[overlap_1_to_1_ihd$soma_non_normal_p_bonferroni<0.05 & sign(overlap_1_to_1_ihd$soma_non_normal_coef)<0] <- "Inverse"
overlap_1_to_1_ihd$soma_non_normal_sig_bonferroni[overlap_1_to_1_ihd$soma_non_normal_p_bonferroni>=0.05] <- "n.s."
overlap_1_to_1_ihd$soma_non_normal_sig_bonferroni <- factor(overlap_1_to_1_ihd$soma_non_normal_sig_bonferroni,levels=c("Positive","Inverse","n.s."))
table(overlap_1_to_1_ihd$soma_non_normal_sig_bonferroni)
n_sig <- sum(overlap_1_to_1_ihd$soma_non_normal_sig_bonferroni!="n.s.")

soma_non_normal_threshold <- max(overlap_1_to_1_ihd$soma_non_normal_p[overlap_1_to_1_ihd$soma_non_normal_p_bonferroni<0.05])

volcano_soma_non_normal <- ggplot(overlap_1_to_1_ihd, aes(x=soma_non_normal_coef, y=-log(soma_non_normal_p,10))) +
  geom_point(aes(color = soma_non_normal_sig_bonferroni), size = 0.5) +
...
c1 <- as.numeric(sum(overlap_1_to_1_ihd$olink_p_bonferroni<0.05))
c2 <- as.numeric(sum(overlap_1_to_1_ihd$soma_normal_p_bonferroni<0.05))
c3 <- as.numeric(sum(overlap_1_to_1_ihd$olink_p_bonferroni<0.05 & overlap_1_to_1_ihd$soma_normal_p_bonferroni<0.05))
c4 <- as.numeric(sum(overlap_1_to_1_ihd$olink_p_bonferroni<0.05 & overlap_1_to_1_ihd$soma_normal_p_bonferroni<0.05 & sign(overlap_1_to_1_ihd$olink_coef)==sign(overlap_1_to_1_ihd$soma_normal_coef)))
...
overlap_1_to_1_ihd$olink_soma_normal_sig_bonferroni <- NA
overlap_1_to_1_ihd$olink_soma_normal_sig_bonferroni[overlap_1_to_1_ihd$olink_p_bonferroni<0.05 & overlap_1_to_1_ihd$soma_normal_p_bonferroni<0.05 &
...
overlap_1_to_1_ihd$olink_soma_normal_sig_bonferroni[overlap_1_to_1_ihd$olink_p_bonferroni<0.05 & overlap_1_to_1_ihd$soma_normal_p_bonferroni>=0.05] <- "OLINK-specific"
overlap_1_to_1_ihd$olink_soma_normal_sig_bonferroni[overlap_1_to_1_ihd$olink_p_bonferroni>=0.05 & overlap_1_to_1_ihd$soma_normal_p_bonferroni<0.05] <- "SomaScan-specific"
overlap_1_to_1_ihd$olink_soma_normal_sig_bonferroni[overlap_1_to_1_ihd$olink_p_bonferroni>=0.05 & overlap_1_to_1_ihd$soma_normal_p_bonferroni>=0.05] <- "Neither"
overlap_1_to_1_ihd$olink_soma_normal_sig_bonferroni <- factor(overlap_1_to_1_ihd$olink_soma_normal_sig_bonferroni,levels = c("Shared","Opposite direction","OLINK-specific","SomaScan-specific","Neither"))
table(overlap_1_to_1_ihd$olink_soma_normal_sig_bonferroni)

cor.test(overlap_1_to_1_ihd$olink_coef, overlap_1_to_1_ihd$soma_normal_coef)

cor.test(overlap_1_to_1_ihd$olink_coef[overlap_1_to_1_ihd$olink_soma_normal_sig_bonferroni=="Shared"], 
         overlap_1_to_1_ihd$soma_normal_coef[overlap_1_to_1_ihd$olink_soma_normal_sig_bonferroni=="Shared"])

r_all_normal <- format(round(cor.test(overlap_1_to_1_ihd$olink_coef, overlap_1_to_1_ihd$soma_normal_coef)$estimate,2),nsmall=2)
r_shared_normal <- format(round(cor.test(overlap_1_to_1_ihd$olink_coef[overlap_1_to_1_ihd$olink_soma_normal_sig_bonferroni=="Shared"], 
                                         overlap_1_to_1_ihd$soma_normal_coef[overlap_1_to_1_ihd$olink_soma_normal_sig_bonferroni=="Shared"])$estimate,2),nsmall=2)
...
sum(overlap_1_to_1_ihd$olink_soma_normal_sig_bonferroni=="Shared" & overlap_1_to_1_ihd$coloc_normal_cis_tf==T)
sum(overlap_1_to_1_ihd$olink_soma_normal_sig_bonferroni=="Shared" & overlap_1_to_1_ihd$coloc_normal_cis_tf==T)/sum(overlap_1_to_1_ihd$coloc_normal_cis_tf==T)

scatter_normal <- ggplot(overlap_1_to_1_ihd, aes(x=olink_coef, y=soma_normal_coef, color=olink_soma_normal_sig_bonferroni, stroke=NA)) +
...
c1 <- as.numeric(sum(overlap_1_to_1_ihd$olink_p_bonferroni<0.05))
c2 <- as.numeric(sum(overlap_1_to_1_ihd$soma_non_normal_p_bonferroni<0.05))
c3 <- as.numeric(sum(overlap_1_to_1_ihd$olink_p_bonferroni<0.05 & overlap_1_to_1_ihd$soma_non_normal_p_bonferroni<0.05))
c4 <- as.numeric(sum(overlap_1_to_1_ihd$olink_p_bonferroni<0.05 & overlap_1_to_1_ihd$soma_non_normal_p_bonferroni<0.05 & sign(overlap_1_to_1_ihd$olink_coef)==sign(overlap_1_to_1_ihd$soma_non_normal_coef)))
...
overlap_1_to_1_ihd$olink_soma_non_normal_sig_bonferroni <- NA
overlap_1_to_1_ihd$olink_soma_non_normal_sig_bonferroni[overlap_1_to_1_ihd$olink_p_bonferroni<0.05 & overlap_1_to_1_ihd$soma_non_normal_p_bonferroni<0.05 &
...
overlap_1_to_1_ihd$olink_soma_non_normal_sig_bonferroni[overlap_1_to_1_ihd$olink_p_bonferroni<0.05 & overlap_1_to_1_ihd$soma_non_normal_p_bonferroni>=0.05] <- "OLINK-specific"
overlap_1_to_1_ihd$olink_soma_non_normal_sig_bonferroni[overlap_1_to_1_ihd$olink_p_bonferroni>=0.05 & overlap_1_to_1_ihd$soma_non_normal_p_bonferroni<0.05] <- "SomaScan-specific"
overlap_1_to_1_ihd$olink_soma_non_normal_sig_bonferroni[overlap_1_to_1_ihd$olink_p_bonferroni>=0.05 & overlap_1_to_1_ihd$soma_non_normal_p_bonferroni>=0.05] <- "Neither"
overlap_1_to_1_ihd$olink_soma_non_normal_sig_bonferroni <- factor(overlap_1_to_1_ihd$olink_soma_non_normal_sig_bonferroni,levels = c("Shared","Opposite direction","OLINK-specific","SomaScan-specific","Neither"))
table(overlap_1_to_1_ihd$olink_soma_non_normal_sig_bonferroni)
...
r_shared_non_normal <- format(round(cor.test(overlap_1_to_1_ihd$olink_coef[overlap_1_to_1_ihd$olink_soma_non_normal_sig_bonferroni=="Shared"], 
                                         overlap_1_to_1_ihd$soma_non_normal_coef[overlap_1_to_1_ihd$olink_soma_non_normal_sig_bonferroni=="Shared"])$estimate,2),nsmall=2)
...
sum(overlap_1_to_1_ihd$olink_soma_non_normal_sig_bonferroni=="Shared" & overlap_1_to_1_ihd$coloc_non_normal_cis_tf==T)
sum(overlap_1_to_1_ihd$olink_soma_non_normal_sig_bonferroni=="Shared" & overlap_1_to_1_ihd$coloc_non_normal_cis_tf==T)/sum(overlap_1_to_1_ihd$coloc_non_normal_cis_tf==T)

scatter_non_normal <- ggplot(overlap_1_to_1_ihd, aes(x=olink_coef, y=soma_non_normal_coef, color=olink_soma_non_normal_sig_bonferroni, stroke=NA)) +
  geom_errorbar(aes(xmin = olink_lci, xmax = olink_hci),color="gray80") +
...
c1 <- as.numeric(sum(overlap_1_to_1_ihd$soma_normal_p_bonferroni<0.05))
c2 <- as.numeric(sum(overlap_1_to_1_ihd$soma_non_normal_p_bonferroni<0.05))
c3 <- as.numeric(sum(overlap_1_to_1_ihd$soma_normal_p_bonferroni<0.05 & overlap_1_to_1_ihd$soma_non_normal_p_bonferroni<0.05))
c4 <- as.numeric(sum(overlap_1_to_1_ihd$soma_normal_p_bonferroni<0.05 & overlap_1_to_1_ihd$soma_non_normal_p_bonferroni<0.05 & sign(overlap_1_to_1_ihd$soma_normal_coef)==sign(overlap_1_to_1_ihd$soma_non_normal_coef)))

venn_ihd_soma <- venn.diagram(
  list(soma_normal_sig=1:c1, soma_non_normal_sig=(c1-c3+1):(c1-c3+c2)),
  filename = NULL,
  disable.logging =T,
  fontfamily = "sans",	cat.fontfamily = "sans",
...
venn_ihd_soma[[7]]$label <- paste(venn_ihd_soma[[7]]$label, "\n(", c4, " shared)", sep="")  
...
overlap_1_to_1_ihd$soma_sig_bonferroni <- NA
overlap_1_to_1_ihd$soma_sig_bonferroni[overlap_1_to_1_ihd$soma_normal_p_bonferroni<0.05 & overlap_1_to_1_ihd$soma_non_normal_p_bonferroni<0.05 &
                                                   sign(overlap_1_to_1_ihd$soma_normal_coef)==sign(overlap_1_to_1_ihd$soma_non_normal_coef)] <- "Shared"
overlap_1_to_1_ihd$soma_sig_bonferroni[overlap_1_to_1_ihd$soma_normal_p_bonferroni<0.05 & overlap_1_to_1_ihd$soma_non_normal_p_bonferroni<0.05 &
                                                   sign(overlap_1_to_1_ihd$soma_normal_coef)!=sign(overlap_1_to_1_ihd$soma_non_normal_coef)] <- "Opposite direction"
overlap_1_to_1_ihd$soma_sig_bonferroni[overlap_1_to_1_ihd$soma_normal_p_bonferroni<0.05 & overlap_1_to_1_ihd$soma_non_normal_p_bonferroni>=0.05] <- "OLINK-specific"
overlap_1_to_1_ihd$soma_sig_bonferroni[overlap_1_to_1_ihd$soma_normal_p_bonferroni>=0.05 & overlap_1_to_1_ihd$soma_non_normal_p_bonferroni<0.05] <- "SomaScan-specific"
overlap_1_to_1_ihd$soma_sig_bonferroni[overlap_1_to_1_ihd$soma_normal_p_bonferroni>=0.05 & overlap_1_to_1_ihd$soma_non_normal_p_bonferroni>=0.05] <- "Neither"
overlap_1_to_1_ihd$soma_sig_bonferroni <- factor(overlap_1_to_1_ihd$soma_sig_bonferroni,levels = c("Shared","Opposite direction","OLINK-specific","SomaScan-specific","Neither"))
table(overlap_1_to_1_ihd$soma_sig_bonferroni)

cor.test(overlap_1_to_1_ihd$soma_normal_coef, overlap_1_to_1_ihd$soma_non_normal_coef)
cor.test(overlap_1_to_1_ihd$soma_normal_coef[overlap_1_to_1_ihd$soma_sig_bonferroni=="Shared"],
         overlap_1_to_1_ihd$soma_non_normal_coef[overlap_1_to_1_ihd$soma_sig_bonferroni=="Shared"])

r_all_soma <- format(round(cor.test(overlap_1_to_1_ihd$soma_normal_coef, overlap_1_to_1_ihd$soma_non_normal_coef)$estimate,2),nsmall=2)
r_shared_soma <- format(round(cor.test(overlap_1_to_1_ihd$soma_normal_coef[overlap_1_to_1_ihd$soma_sig_bonferroni=="Shared"], overlap_1_to_1_ihd$soma_non_normal_coef[overlap_1_to_1_ihd$soma_sig_bonferroni=="Shared"])$estimate,2),nsmall=2)

scatter_soma <- ggplot(overlap_1_to_1_ihd, aes(x=soma_normal_coef, y=soma_non_normal_coef, color=soma_sig_bonferroni, stroke=NA)) +
  geom_errorbar(aes(xmin = soma_normal_lci, xmax = soma_normal_hci),color="gray80") +
  geom_errorbar(aes(ymin = soma_non_normal_lci, ymax = soma_non_normal_hci),color="gray80") +
  geom_point(size=1.5,alpha=0.5) +
  xlim(-0.6,0.6) +
  ylim(-0.6,0.6) +
  ...
  theme(legend.position = "none") +
  geom_text_repel(data = top,
                  mapping = aes(x=soma_normal_coef, y=soma_non_normal_coef, label=olink_id),
                  size = 2, color="black")  +
  annotate("text", x = -0.6, y = 0.6, label = paste("r =", r_all_soma, "(all, n = 1694)"), size = 12/.pt, hjust = 0) +
  annotate("text", x = -0.6, y = 0.55, label = paste0("r = ", r_shared_soma, " (shared, n = ", c4,")"), size = 12/.pt, hjust = 0)
...
overlap_1_to_1_ihd$olink_soma_normal_sig_bonferroni <- factor(overlap_1_to_1_ihd$olink_soma_normal_sig_bonferroni,levels = c("OLINK-specific","SomaScan-specific","Shared","Opposite direction","Neither"))
overlap_1_to_1_ihd$olink_soma_non_normal_sig_bonferroni <- factor(overlap_1_to_1_ihd$olink_soma_non_normal_sig_bonferroni,levels = c("OLINK-specific","Shared","SomaScan-specific","Opposite direction","Neither"))

median_rho_all_normal <- format(round(median(overlap_1_to_1_ihd$rho_olink_soma_normal),2),nsmall=2)
median_rho_shared_normal <- format(round(median(overlap_1_to_1_ihd$rho_olink_soma_normal[overlap_1_to_1_ihd$olink_soma_normal_sig_bonferroni=="Shared"]),2),nsmall=2)

hist_ihd_normal <- ggplot(overlap_1_to_1_ihd, aes(x=rho_olink_soma_normal, fill=olink_soma_normal_sig_bonferroni)) + 
  ...
  annotate("text", x = -0.4, y = 285, label = paste0("Median rho = ", median_rho_shared_normal, " (shared, n = ", sum(overlap_1_to_1_ihd$olink_soma_normal_sig_bonferroni=="Shared"), ")"), size = 12/.pt, hjust = 0)

hist_ihd_normal

median_rho_all_non_normal <- format(round(median(overlap_1_to_1_ihd$rho_olink_soma_non_normal),2),nsmall=2)
median_rho_shared_non_normal <- format(round(median(overlap_1_to_1_ihd$rho_olink_soma_non_normal[overlap_1_to_1_ihd$olink_soma_non_normal_sig_bonferroni=="Shared"]),2),nsmall=2)

hist_ihd_non_normal <- ggplot(overlap_1_to_1_ihd, aes(x=rho_olink_soma_non_normal, fill=olink_soma_non_normal_sig_bonferroni)) + 
  geom_histogram(binwidth = 0.05,boundary=0,color="black") +
  scale_x_continuous(breaks = seq(-0.4, 1, 0.2), lim = c(-0.4, 1), labels = label_number(accuracy = 0.1)) +
  ylim(0,300) +
  ggtitle("OLINK vs SomaScan-non-ANML", subtitle ="") +
  ...
  annotate("text", x = -0.4, y = 285, label = paste0("Median rho = ", median_rho_shared_non_normal, " (shared, n = ", sum(overlap_1_to_1_ihd$olink_soma_non_normal_sig_bonferroni=="Shared"), ")"), size = 12/.pt, hjust = 0)

hist_ihd_non_normal

legend <- as_ggplot(get_legend(ggplot(overlap_1_to_1_ihd, aes(x=rho_olink_soma_normal, fill=olink_soma_normal_sig_bonferroni)) + 
...
# hist_ihd_cat <- grid.arrange(hist_ihd_olink_normal,hist_ihd_olink_non_normal,
#                              hist_ihd_soma_normal,hist_ihd_soma_non_normal,
#                              hist_ihd_shared_normal,hist_ihd_shared_non_normal,
#                              hist_ihd_opposite_normal,hist_ihd_opposite_non_normal,
...
overlap_1_to_1_ihd$olink_soma_normal_shared[overlap_1_to_1_ihd$olink_soma_normal_sig_bonferroni=="Shared"] <- "Yes"
...
overlap_1_to_1_ihd$olink_soma_non_normal_shared[overlap_1_to_1_ihd$olink_soma_non_normal_sig_bonferroni=="Shared"] <- "Yes"
...
c1 <- as.numeric(sum(overlap_1_to_1_ihd$soma_normal_p_fdr<0.05))
c2 <- as.numeric(sum(overlap_1_to_1_ihd$soma_non_normal_p_fdr<0.05))
c3 <- as.numeric(sum(overlap_1_to_1_ihd$soma_normal_p_fdr<0.05 & overlap_1_to_1_ihd$soma_non_normal_p_fdr<0.05))
c4 <- as.numeric(sum(overlap_1_to_1_ihd$soma_normal_p_fdr<0.05 & overlap_1_to_1_ihd$soma_non_normal_p_fdr<0.05 & sign(overlap_1_to_1_ihd$soma_normal_coef)==sign(overlap_1_to_1_ihd$soma_non_normal_coef)))
...
overlap_1_to_1_ihd$soma_sig_fdr <- NA
overlap_1_to_1_ihd$soma_sig_fdr[overlap_1_to_1_ihd$soma_normal_p_fdr<0.05 & overlap_1_to_1_ihd$soma_non_normal_p_fdr<0.05 &
                                         sign(overlap_1_to_1_ihd$soma_normal_coef)==sign(overlap_1_to_1_ihd$soma_non_normal_coef)] <- "Shared"
overlap_1_to_1_ihd$soma_sig_fdr[overlap_1_to_1_ihd$soma_normal_p_fdr<0.05 & overlap_1_to_1_ihd$soma_non_normal_p_fdr<0.05 &
                                         sign(overlap_1_to_1_ihd$soma_normal_coef)!=sign(overlap_1_to_1_ihd$soma_non_normal_coef)] <- "Opposite direction"
overlap_1_to_1_ihd$soma_sig_fdr[overlap_1_to_1_ihd$soma_normal_p_fdr<0.05 & overlap_1_to_1_ihd$soma_non_normal_p_fdr>=0.05] <- "OLINK-specific"
overlap_1_to_1_ihd$soma_sig_fdr[overlap_1_to_1_ihd$soma_normal_p_fdr>=0.05 & overlap_1_to_1_ihd$soma_non_normal_p_fdr<0.05] <- "SomaScan-specific"
overlap_1_to_1_ihd$soma_sig_fdr[overlap_1_to_1_ihd$soma_normal_p_fdr>=0.05 & overlap_1_to_1_ihd$soma_non_normal_p_fdr>=0.05] <- "Neither"
overlap_1_to_1_ihd$soma_sig_fdr <- factor(overlap_1_to_1_ihd$soma_sig_fdr,levels = c("Shared","Opposite direction","OLINK-specific","SomaScan-specific","Neither"))
table(overlap_1_to_1_ihd$soma_sig_fdr)

cor.test(overlap_1_to_1_ihd$soma_normal_coef, overlap_1_to_1_ihd$soma_non_normal_coef)
cor.test(overlap_1_to_1_ihd$soma_normal_coef[overlap_1_to_1_ihd$soma_sig_fdr=="Shared"],
         overlap_1_to_1_ihd$soma_non_normal_coef[overlap_1_to_1_ihd$soma_sig_fdr=="Shared"])

r_all_soma <- format(round(cor.test(overlap_1_to_1_ihd$soma_normal_coef, overlap_1_to_1_ihd$soma_non_normal_coef)$estimate,2),nsmall=2)
r_shared_soma <- format(round(cor.test(overlap_1_to_1_ihd$soma_normal_coef[overlap_1_to_1_ihd$soma_sig_fdr=="Shared"], overlap_1_to_1_ihd$soma_non_normal_coef[overlap_1_to_1_ihd$soma_sig_fdr=="Shared"])$estimate,2),nsmall=2)

scatter_soma <- ggplot(overlap_1_to_1_ihd, aes(x=soma_normal_coef, y=soma_non_normal_coef, color=soma_sig_fdr, stroke=NA)) +
  geom_errorbar(aes(xmin = soma_normal_lci, xmax = soma_normal_hci),color="gray80") +
  geom_errorbar(aes(ymin = soma_non_normal_lci, ymax = soma_non_normal_hci),color="gray80") +
  geom_point(size=1.5,alpha=0.5) +
  xlim(-0.6,0.6) +
