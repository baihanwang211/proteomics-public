...
bmi_sd <- sd(olink_pheno$bmi_calc)
...
bmi$olink_sig_bonferroni <- F
bmi$olink_sig_bonferroni[bmi$olink_p_bonferroni_bmi_calc<0.05 & sign(bmi$olink_es_bmi_calc)>0] <- "Positive"
bmi$olink_sig_bonferroni[bmi$olink_p_bonferroni_bmi_calc<0.05 & sign(bmi$olink_es_bmi_calc)<0] <- "Inverse"
bmi$olink_sig_bonferroni[bmi$olink_p_bonferroni_bmi_calc>=0.05] <- "n.s."
bmi$olink_sig_bonferroni <- factor(bmi$olink_sig_bonferroni,levels=c("Positive","Inverse","n.s."))
table(bmi$olink_sig_bonferroni)
n_sig <- sum(bmi$olink_sig_bonferroni!="n.s.")
...
olink_threshold <- max(bmi$olink_p_bmi_calc[bmi$olink_p_bonferroni_bmi_calc<0.05])
...
bmi$soma_normal_sig_bonferroni <- F
bmi$soma_normal_sig_bonferroni[bmi$soma_normal_p_bonferroni_bmi_calc<0.05 & sign(bmi$soma_normal_es_bmi_calc)>0] <- "Positive"
bmi$soma_normal_sig_bonferroni[bmi$soma_normal_p_bonferroni_bmi_calc<0.05 & sign(bmi$soma_normal_es_bmi_calc)<0] <- "Inverse"
bmi$soma_normal_sig_bonferroni[bmi$soma_normal_p_bonferroni_bmi_calc>=0.05] <- "n.s."
bmi$soma_normal_sig_bonferroni <- factor(bmi$soma_normal_sig_bonferroni,levels=c("Positive","Inverse","n.s."))
...
soma_normal_threshold <- max(bmi$soma_normal_p_bmi_calc[bmi$soma_normal_p_bonferroni_bmi_calc<0.05])
...
bmi$soma_non_normal_sig_bonferroni <- F
bmi$soma_non_normal_sig_bonferroni[bmi$soma_non_normal_p_bonferroni_bmi_calc<0.05 & sign(bmi$soma_non_normal_es_bmi_calc)>0] <- "Positive"
bmi$soma_non_normal_sig_bonferroni[bmi$soma_non_normal_p_bonferroni_bmi_calc<0.05 & sign(bmi$soma_non_normal_es_bmi_calc)<0] <- "Inverse"
bmi$soma_non_normal_sig_bonferroni[bmi$soma_non_normal_p_bonferroni_bmi_calc>=0.05] <- "n.s."
bmi$soma_non_normal_sig_bonferroni <- factor(bmi$soma_non_normal_sig_bonferroni,levels=c("Positive","Inverse","n.s."))
...
soma_non_normal_threshold <- max(bmi$soma_non_normal_p_bmi_calc[bmi$soma_non_normal_p_bonferroni_bmi_calc<0.05],na.rm = T)
...
c1 <- as.numeric(sum(bmi$olink_p_bonferroni_bmi_calc<0.05))
c2 <- as.numeric(sum(bmi$soma_normal_p_bonferroni_bmi_calc<0.05))
c3 <- as.numeric(sum(bmi$olink_p_bonferroni_bmi_calc<0.05 & bmi$soma_normal_p_bonferroni_bmi_calc<0.05))
c4 <- as.numeric(sum(bmi$olink_p_bonferroni_bmi_calc<0.05 & bmi$soma_normal_p_bonferroni_bmi_calc<0.05 & sign(bmi$olink_es_bmi_calc)==sign(bmi$soma_normal_es_bmi_calc)))
...
bmi$olink_soma_normal_sig_bonferroni <- NA
bmi$olink_soma_normal_sig_bonferroni[bmi$olink_p_bonferroni_bmi_calc<0.05 & bmi$soma_normal_p_bonferroni_bmi_calc<0.05 &
...
bmi$olink_soma_normal_sig_bonferroni[bmi$olink_p_bonferroni_bmi_calc<0.05 & bmi$soma_normal_p_bonferroni_bmi_calc>=0.05] <- "OLINK-specific"
bmi$olink_soma_normal_sig_bonferroni[bmi$olink_p_bonferroni_bmi_calc>=0.05 & bmi$soma_normal_p_bonferroni_bmi_calc<0.05] <- "SomaScan-specific"
bmi$olink_soma_normal_sig_bonferroni[bmi$olink_p_bonferroni_bmi_calc>=0.05 & bmi$soma_normal_p_bonferroni_bmi_calc>=0.05] <- "Neither"
bmi$olink_soma_normal_sig_bonferroni <- factor(bmi$olink_soma_normal_sig_bonferroni,levels = c("Shared","Opposite direction","OLINK-specific","SomaScan-specific","Neither"))
table(bmi$olink_soma_normal_sig_bonferroni)

r_all_normal <- format(round(cor.test(bmi$olink_es_bmi_calc, bmi$soma_normal_es_bmi_calc)$estimate,2),nsmall=2)
r_shared_normal <- format(round(cor.test(bmi$olink_es_bmi_calc[bmi$olink_soma_normal_sig_bonferroni=="Shared"], bmi$soma_normal_es_bmi_calc[bmi$olink_soma_normal_sig_bonferroni=="Shared"])$estimate,2),nsmall=2)
...
sum(bmi$olink_soma_normal_sig_bonferroni=="Shared" & bmi$coloc_normal_cis_tf==T)
sum(bmi$olink_soma_normal_sig_bonferroni=="Shared" & bmi$coloc_normal_cis_tf==T)/sum(bmi$coloc_normal_cis_tf==T)

scatter_normal <- ggplot(bmi, aes(x=olink_es_bmi_calc*bmi_sd, y=soma_normal_es_bmi_calc*bmi_sd, color=olink_soma_normal_sig_bonferroni, stroke=NA)) +
...
c1 <- as.numeric(sum(bmi$olink_p_bonferroni_bmi_calc<0.05))
c2 <- as.numeric(sum(bmi$soma_non_normal_p_bonferroni_bmi_calc<0.05))
c3 <- as.numeric(sum(bmi$olink_p_bonferroni_bmi_calc<0.05 & bmi$soma_non_normal_p_bonferroni_bmi_calc<0.05))
c4 <- as.numeric(sum(bmi$olink_p_bonferroni_bmi_calc<0.05 & bmi$soma_non_normal_p_bonferroni_bmi_calc<0.05 & sign(bmi$olink_es_bmi_calc)==sign(bmi$soma_non_normal_es_bmi_calc)))
...
bmi$olink_soma_non_normal_sig_bonferroni <- NA
bmi$olink_soma_non_normal_sig_bonferroni[bmi$olink_p_bonferroni_bmi_calc<0.05 & bmi$soma_non_normal_p_bonferroni_bmi_calc<0.05 &
...
bmi$olink_soma_non_normal_sig_bonferroni[bmi$olink_p_bonferroni_bmi_calc<0.05 & bmi$soma_non_normal_p_bonferroni_bmi_calc>=0.05] <- "OLINK-specific"
bmi$olink_soma_non_normal_sig_bonferroni[bmi$olink_p_bonferroni_bmi_calc>=0.05 & bmi$soma_non_normal_p_bonferroni_bmi_calc<0.05] <- "SomaScan-specific"
bmi$olink_soma_non_normal_sig_bonferroni[bmi$olink_p_bonferroni_bmi_calc>=0.05 & bmi$soma_non_normal_p_bonferroni_bmi_calc>=0.05] <- "Neither"
bmi$olink_soma_non_normal_sig_bonferroni <- factor(bmi$olink_soma_non_normal_sig_bonferroni,levels = c("Shared","Opposite direction","OLINK-specific","SomaScan-specific","Neither"))
table(bmi$olink_soma_non_normal_sig_bonferroni)

r_all_non_normal <- format(round(cor.test(bmi$olink_es_bmi_calc, bmi$soma_non_normal_es_bmi_calc)$estimate,2),nsmall=2)
r_shared_non_normal <- format(round(cor.test(bmi$olink_es_bmi_calc[bmi$olink_soma_non_normal_sig_bonferroni=="Shared"], bmi$soma_non_normal_es_bmi_calc[bmi$olink_soma_non_normal_sig_bonferroni=="Shared"])$estimate,2),nsmall=2)
...
sum(bmi$olink_soma_non_normal_sig_bonferroni=="Shared" & bmi$coloc_non_normal_cis_tf==T)
sum(bmi$olink_soma_non_normal_sig_bonferroni=="Shared" & bmi$coloc_non_normal_cis_tf==T)/sum(bmi$coloc_non_normal_cis_tf==T)

scatter_non_normal <- ggplot(bmi, aes(x=olink_es_bmi_calc*bmi_sd, y=soma_non_normal_es_bmi_calc*bmi_sd, color=olink_soma_non_normal_sig_bonferroni, stroke=NA)) +
  geom_errorbar(aes(xmin = olink_lci_bmi_calc*bmi_sd, xmax = olink_hci_bmi_calc*bmi_sd),color="gray80") +
...
c1 <- as.numeric(sum(bmi$soma_normal_p_bonferroni_bmi_calc<0.05))
c2 <- as.numeric(sum(bmi$soma_non_normal_p_bonferroni_bmi_calc<0.05))
c3 <- as.numeric(sum(bmi$soma_normal_p_bonferroni_bmi_calc<0.05 & bmi$soma_non_normal_p_bonferroni_bmi_calc<0.05))
c4 <- as.numeric(sum(bmi$soma_normal_p_bonferroni_bmi_calc<0.05 & bmi$soma_non_normal_p_bonferroni_bmi_calc<0.05 & sign(bmi$soma_normal_p_bonferroni_bmi_calc)==sign(bmi$soma_non_normal_es_bmi_calc)))

venn_diagram_bmi_soma <- venn.diagram(
  list(olink = 1:c1,soma = (c1-c3+1):(c1-c3+c2)),
  filename = NULL,
  fontfamily = "sans",	cat.fontfamily = "sans",
...
venn_diagram_bmi_soma[[7]]$label <- paste(venn_diagram_bmi_soma[[7]]$label, "\n", c4 ," (", format(round(c4/c3*100,digits=1),nsmall=1), "%) colocalise", sep="")  
...
bmi$soma_sig_bonferroni <- NA
bmi$soma_sig_bonferroni[bmi$soma_normal_p_bonferroni_bmi_calc<0.05 & bmi$soma_non_normal_p_bonferroni_bmi_calc<0.05 &
                                    sign(bmi$soma_normal_es_bmi_calc)==sign(bmi$soma_non_normal_es_bmi_calc)] <- "Shared"
bmi$soma_sig_bonferroni[bmi$soma_normal_p_bonferroni_bmi_calc<0.05 & bmi$soma_non_normal_p_bonferroni_bmi_calc<0.05 &
                                    sign(bmi$soma_normal_es_bmi_calc)!=sign(bmi$soma_non_normal_es_bmi_calc)] <- "Opposite direction"
bmi$soma_sig_bonferroni[bmi$soma_normal_p_bonferroni_bmi_calc<0.05 & bmi$soma_non_normal_p_bonferroni_bmi_calc>=0.05] <- "OLINK-specific"
bmi$soma_sig_bonferroni[bmi$soma_normal_p_bonferroni_bmi_calc>=0.05 & bmi$soma_non_normal_p_bonferroni_bmi_calc<0.05] <- "SomaScan-specific"
bmi$soma_sig_bonferroni[bmi$soma_normal_p_bonferroni_bmi_calc>=0.05 & bmi$soma_non_normal_p_bonferroni_bmi_calc>=0.05] <- "Neither"
bmi$soma_sig_bonferroni <- factor(bmi$soma_sig_bonferroni,levels = c("Shared","Opposite direction","OLINK-specific","SomaScan-specific","Neither"))
table(bmi$soma_sig_bonferroni)

r_all_soma <- format(round(cor.test(bmi$soma_normal_es_bmi_calc, bmi$soma_non_normal_es_bmi_calc)$estimate,2),nsmall=2)
r_shared_soma <- format(round(cor.test(bmi$soma_normal_es_bmi_calc[bmi$soma_sig_bonferroni=="Shared"], bmi$soma_non_normal_es_bmi_calc[bmi$soma_sig_bonferroni=="Shared"])$estimate,2),nsmall=2)

scatter_plot_soma <- ggplot(bmi, aes(x=soma_normal_es_bmi_calc*bmi_sd, y=soma_non_normal_es_bmi_calc*bmi_sd, color=soma_sig_bonferroni, stroke=NA)) +
  geom_errorbar(aes(xmin = soma_normal_lci_bmi_calc*bmi_sd, xmax = soma_normal_hci_bmi_calc*bmi_sd),color="gray80") +
  geom_errorbar(aes(ymin = soma_non_normal_lci_bmi_calc*bmi_sd, ymax = soma_non_normal_hci_bmi_calc*bmi_sd),color="gray80") +
  geom_point(size=1.5,alpha=0.5) +
  xlim(-0.6,0.6) +
  ylim(-0.6,0.6) +
  ...
  theme(legend.position = "none") +
  geom_text_repel(data = soma_normal_top,
                   mapping = aes(x=soma_normal_es_bmi_calc*bmi_sd, y=soma_non_normal_es_bmi_calc*bmi_sd, label=olink_id),
                   size = 2, color="black")  +
...
bmi$olink_soma_normal_sig_bonferroni <- factor(bmi$olink_soma_normal_sig_bonferroni,levels = c("OLINK-specific","Shared","SomaScan-specific","Opposite direction","Neither"))
bmi$olink_soma_non_normal_sig_bonferroni <- factor(bmi$olink_soma_non_normal_sig_bonferroni,levels = c("OLINK-specific","Shared","SomaScan-specific","Opposite direction","Neither"))

median_rho_all_normal <- format(round(median(bmi$rho_olink_soma_normal),2),nsmall=2)
median_rho_shared_normal <- format(round(median(bmi$rho_olink_soma_normal[bmi$olink_soma_normal_sig_bonferroni=="Shared"]),2),nsmall=2)

hist_bmi_normal <- ggplot(bmi, aes(x=rho_olink_soma_normal, fill=olink_soma_normal_sig_bonferroni)) + 
  ...
  annotate("text", x = -0.4, y = 285, label = paste0("Median rho = ", median_rho_shared_normal, " (shared, n = ", sum(bmi$olink_soma_normal_sig_bonferroni=="Shared"), ")"), size = 12/.pt, hjust = 0)

hist_bmi_normal


median_rho_all_non_normal <- format(round(median(bmi$rho_olink_soma_non_normal),2),nsmall=2)
median_rho_shared_non_normal <- format(round(median(bmi$rho_olink_soma_non_normal[bmi$olink_soma_non_normal_sig_bonferroni=="Shared"]),2),nsmall=2)

hist_bmi_non_normal <- ggplot(bmi, aes(x=rho_olink_soma_non_normal, fill=olink_soma_non_normal_sig_bonferroni)) + 
  geom_histogram(binwidth = 0.05,boundary=0,color="black") +
  scale_x_continuous(breaks = seq(-0.4, 1, 0.2), lim = c(-0.4, 1), labels = label_number(accuracy = 0.1)) +
  ylim(0,300) +
  ggtitle("OLINK vs SomaScan-non-ANML", subtitle ="") +
  ...
  annotate("text", x = -0.4, y = 285, label = paste0("Median rho = ", median_rho_shared_non_normal, " (shared, n = ", sum(bmi$olink_soma_non_normal_sig_bonferroni=="Shared"), ")"), size = 12/.pt, hjust = 0)
...
bmi$olink_soma_normal_shared[bmi$olink_soma_normal_sig_bonferroni=="Shared"] <- "Yes"
...
bmi$olink_soma_non_normal_shared[bmi$olink_soma_non_normal_sig_bonferroni=="Shared"] <- "Yes"
...
c1 <- as.numeric(sum(bmi$soma_normal_p_fdr_bmi_calc<0.05))
c2 <- as.numeric(sum(bmi$soma_non_normal_p_fdr_bmi_calc<0.05))
c3 <- as.numeric(sum(bmi$soma_normal_p_fdr_bmi_calc<0.05 & bmi$soma_non_normal_p_fdr_bmi_calc<0.05))
c4 <- as.numeric(sum(bmi$soma_normal_p_fdr_bmi_calc<0.05 & bmi$soma_non_normal_p_fdr_bmi_calc<0.05 & sign(bmi$soma_normal_p_fdr_bmi_calc)==sign(bmi$soma_non_normal_es_bmi_calc)))
...
bmi$soma_sig_fdr <- NA
bmi$soma_sig_fdr[bmi$soma_normal_p_fdr_bmi_calc<0.05 & bmi$soma_non_normal_p_fdr_bmi_calc<0.05 &
                          sign(bmi$soma_normal_es_bmi_calc)==sign(bmi$soma_non_normal_es_bmi_calc)] <- "Shared"
bmi$soma_sig_fdr[bmi$soma_normal_p_fdr_bmi_calc<0.05 & bmi$soma_non_normal_p_fdr_bmi_calc<0.05 &
                          sign(bmi$soma_normal_es_bmi_calc)!=sign(bmi$soma_non_normal_es_bmi_calc)] <- "Opposite direction"
bmi$soma_sig_fdr[bmi$soma_normal_p_fdr_bmi_calc<0.05 & bmi$soma_non_normal_p_fdr_bmi_calc>=0.05] <- "OLINK-specific"
bmi$soma_sig_fdr[bmi$soma_normal_p_fdr_bmi_calc>=0.05 & bmi$soma_non_normal_p_fdr_bmi_calc<0.05] <- "SomaScan-specific"
bmi$soma_sig_fdr[bmi$soma_normal_p_fdr_bmi_calc>=0.05 & bmi$soma_non_normal_p_fdr_bmi_calc>=0.05] <- "Neither"
bmi$soma_sig_fdr <- factor(bmi$soma_sig_fdr,levels = c("Shared","Opposite direction","OLINK-specific","SomaScan-specific","Neither"))
table(bmi$soma_sig_fdr)

r_all_soma <- format(round(cor.test(bmi$soma_normal_es_bmi_calc, bmi$soma_non_normal_es_bmi_calc)$estimate,2),nsmall=2)
r_shared_soma <- format(round(cor.test(bmi$soma_normal_es_bmi_calc[bmi$soma_sig_fdr=="Shared"], bmi$soma_non_normal_es_bmi_calc[bmi$soma_sig_fdr=="Shared"])$estimate,2),nsmall=2)

scatter_plot_soma <- ggplot(bmi, aes(x=soma_normal_es_bmi_calc*bmi_sd, y=soma_non_normal_es_bmi_calc*bmi_sd, color=soma_sig_fdr, stroke=NA)) +
  geom_errorbar(aes(xmin = soma_normal_lci_bmi_calc*bmi_sd, xmax = soma_normal_hci_bmi_calc*bmi_sd),color="gray80") +
  geom_errorbar(aes(ymin = soma_non_normal_lci_bmi_calc*bmi_sd, ymax = soma_non_normal_hci_bmi_calc*bmi_sd),color="gray80") +
  geom_point(size=1.5,alpha=0.5) +
  xlim(-0.6,0.6) +
