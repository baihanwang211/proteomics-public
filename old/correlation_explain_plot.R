...
ggsave("K:/kadoorie/Staff_Folders/BaihanW/proteomics/results/boruta_normal_plot.png",boruta_normal_plot,width=15,height=10)
...
ggsave("K:/kadoorie/Staff_Folders/BaihanW/proteomics/results/boruta_non_normal_plot.png",boruta_non_normal_plot,width=15,height=10)
